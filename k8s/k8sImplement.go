...
// InitClient 初始Kubernetes Client
...
// IsHasDeploy 判断指定的Deployment是否部署
...
// ReplaceDeploy 替换指定Deployment的镜像和环境变量信息
